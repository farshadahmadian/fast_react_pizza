...
function Header() {
  return (
    <header className="grid grid-cols-[auto_auto] grid-rows-2 items-center gap-2 border-b border-stone-200 bg-yellow-500 px-4 py-3 uppercase md:flex md:items-center md:justify-between md:px-6">
