...
function Header() {
  ...
  return (
    <header className="grid min-h-16 grid-cols-[auto_auto] grid-rows-2 items-center gap-2 border-b border-stone-200 bg-yellow-500 px-4 py-5 font-semibold uppercase sm:px-4 sm:py-3 md:flex md:items-center md:justify-between md:px-6">
